...
const Home = () => {
  ...
  return (
    <div>
        ...
        <div className='flex flex-col gap-2 text-wrap col-span-2'>
          ...
          <div className="flex items-center gap-2">
            ...
            <Tooltip>
              <TooltipTrigger>
              {/* Button for Resume */}
              <a href="https://drive.google.com/file/d/1wtxqpcC9Pv4WE5LVXtVMbn6zMprXIFuB/view?usp=sharing" target="_blank" rel="noopener noreferrer">
        ...
        <div className='w-fit p-4'>
          <div  className='flex items-center justify-between'>
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <a href="https://drive.google.com/file/d/1bM3of58iIXcUcR_bgRww9GAmzFXXUlqB/view?usp=sharing" target="_blank" rel="noopener noreferrer" className='flex items-center gap-2'>
                    <Link2 className='h-4 w-4' />
                  </a>
                </TooltipTrigger>
                <TooltipContent>
                  <p>View Internship Certificate</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
      ...
      <section className='flex flex-col gap-5 pb-10'>
        ...
        <div className='w-fit p-4'>
          <div className='flex items-center justify-between'>
            ...
            <Tooltip>
              <TooltipTrigger>
                <a href="https://drive.google.com/file/d/1YyQqRaJiel0VA29FIzbzJd-vvFpvVCr5/view?usp=sharing" target="_blank" rel="noopener noreferrer" className='flex items-center gap-2'>
                  <Link2 className='h-4 w-4' />
                </a>
              </TooltipTrigger>
              <TooltipContent>
      ...
      <section className='flex flex-col gap-5 pb-10'>
        <h2 className='text-2xl'>Certificates and Awards</h2>
        <div className='w-fit p-4'>
          <div className='flex items-center justify-between'>
            ...
            <Tooltip>
            <TooltipTrigger>
            <a href="https://coursera.org/share/76c91ddbdc71ee472ffdb599bccce3ad" target="_blank" rel="noopener noreferrer" className='flex items-center gap-2'>
              <Link2 className='h-4 w-4' />
            </a>
            </TooltipTrigger>
            <TooltipContent>

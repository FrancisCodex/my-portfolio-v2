  ...
  return (
    <div>
      <section className='flex flex-col-reverse items-center md:grid md:grid-cols-3 w-full gap-3 md:gap-0'>
        <div className='flex flex-col gap-2 text-wrap col-span-2'>
          ...
          <div className="flex items-center gap-2">
              <a href="https://github.com/FrancisCodex" className="text-black dark:text-white">
              ...
              <a href="https://www.linkedin.com/in/francisaltesing/" className="text-black dark:text-white">
      ...
      <section className='flex flex-col gap-5 pb-10'>
        ...
        <ul className='grid grid-cols-2 md:grid-cols-5 gap-2 text-zinc-500'>
